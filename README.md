...
Esta configuracion esta basada en la configuracion utilizada para implementar CI/CD en la API consultarnc.com.do
...
Nota: Estos secrets deben de crearse por repositorio, NO por environment
...
mkdir -p /home/{username}/public_html/releases
mkdir -p /home/{username}/public_html/shared/storage
mkdir -p /home/{username}/public_html/shared/uploads
mkdir -p /home/{username}/public_html/scripts
```
...
cp env.production.example /home/{username}/public_html/shared/.env
# Editar con los valores correctos de producción
nano /home/{username}/public_html/shared/.env
```
...
chmod 755 /home/{username}/public_html/shared/storage
chmod 755 /home/{username}/public_html/shared/uploads
chmod 600 /home/{username}/public_html/shared/.env
```

### 3. Clave SSH

Puedes seguir estos pasos para agregar una clave SSH, pero si cuentas con una interfaz grafica en tu servidor, tambien podrias hacerlo por allí.
...
cat ~/.ssh/id_ed25519.pub >> /home/{username}/.ssh/authorized_keys
...
ssh {username}@consultarnc.com.do
cd /home/{username}/public_html/consultaRNC
./deployment-scripts/health-check.sh
```
...
_Última actualización: $(date +'%Y-%m-%d')_
